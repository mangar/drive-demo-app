...
import rga.google.demo.drive.Constants;
...
public class AuthenticationHelper {
	...
	public static GoogleAuthorizationCodeFlow getFlow() throws IOException {
		if (flow == null) {
			...
			flow = new GoogleAuthorizationCodeFlow.Builder(httpTransport, jsonFactory, Constants.CLIENT_ID,
					Constants.CLIENT_SECRET, Constants.SCOPES).setAccessType(null).setApprovalPrompt("force").build();
